...
class ActionFilterItem(QListWidgetItem):
    def __init__(self, name=None, icon='color.png', parent=None):
        super(ActionFilterItem, self).__init__(name, parent=parent)
...
class GrayingItem(ActionFilterItem):
    def __init__(self, parent=None):
        super(GrayingItem, self).__init__('Grayscale ', icon='grayscale.png', parent=parent)
...
class FilterItem(ActionFilterItem):
...
class MorphItem(ActionFilterItem):
    def __init__(self, parent=None):
...
class GradItem(ActionFilterItem):

    def __init__(self, parent=None):
        super().__init__('Gradient', parent=parent)
    ...
    def __call__(self, img):
        if self._dx == 0 and self._dy == 0 and self._kind != LAPLACIAN_GRAD:
            ...
            self.setText('Image gradient (invalid: 0 when dx is different from dy)')
        else:
            self.setBackground(QColor(200, 200, 200))
            self.setText('Image gradient')
...
class ThresholdItem(ActionFilterItem):
    def __init__(self, parent=None):
...
class EdgeItem(ActionFilterItem):
    def __init__(self, parent=None):
...
class ContourItem(ActionFilterItem):
    def __init__(self, parent=None):
        super(ContourItem, self).__init__('Contour', parent=parent)
...
class EqualizeItem(ActionFilterItem):
    def __init__(self, parent=None):
...
class HoughLineItem(ActionFilterItem):
    def __init__(self, parent=None):
        super(HoughLineItem, self).__init__('Straight-Line Detection', parent=parent)
        self._rho = 1
...
class LightItem(ActionFilterItem):
    def __init__(self, parent=None):
        super(LightItem, self).__init__('Brightness', parent=parent)
        self._alpha = 1
        self._beta = 0
...
class GammaItem(ActionFilterItem):
    def __init__(self, parent=None):
        super(GammaItem, self).__init__('Gamma Correction', parent=parent)
        self._gamma = 1
